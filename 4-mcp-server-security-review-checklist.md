...
| LO-02 | Document server threat model |
| LO-03 | Maintain review decision record |
| LO-04 | Define ownership, patch SLA, and recurring review |
...
### Control
Each MCP server should have a short threat model describing assets, actors, trust boundaries, credentials, high-risk tools, data flows, downstream systems, and accepted risks.
...
### Review Questions
- What assets can the server access?
- What can it change?
...
### Pass Criteria
- Threat model exists.
- Major assets, trust boundaries, credentials, and abuse cases are documented.
- Threat model is updated after major changes.
...
### Control
Keep a record of approval decision, accepted risks, compensating controls, required follow-up, reviewers, owners, and expiration dates for exceptions.
...
### Control
Every MCP server should have a named owner, patch SLA, support contact, and recurring review schedule.

### Evidence to Collect
- Owner/team record
- CODEOWNERS or service catalog entry
...
### Review Questions
- Who owns the server?
- Who receives security findings?
- How fast are critical/high vulnerabilities patched?
- Is there an annual or periodic re-review?
- Are vendor/fork incidents routed to the correct team?

### Pass Criteria
- Owner and support path are documented.
- Patch SLA exists.
- Recurring review cadence is defined.
